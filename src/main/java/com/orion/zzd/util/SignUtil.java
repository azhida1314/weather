...
public class SignUtil {
    ...
    private static String buildStringToSign(String method, String path,
                                            ...
                                            Map<String, String> querys,
                                            Map<String, String> bodys,
                                            List<String> signHeaderPrefixList)throws Exception {
     ...
     * @return 待签名
     */
    private static String buildResource(String path, Map<String, String> querys, Map<String, String> bodys)throws Exception {
        StringBuilder sb = new StringBuilder();
     ...
     * @return 待签名Http头
     */
    private static String buildHeaders(Map<String, String> headers, List<String> signHeaderPrefixList)throws Exception {
        StringBuilder sb = new StringBuilder();
     ...
     * Http头是否参与签名 return
     */
    private static boolean isHeaderToSign(String headerName, List<String> signHeaderPrefixList)throws Exception {
